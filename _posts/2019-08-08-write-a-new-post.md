...
```markdown
![Desktop View](/common/img/cat.jpg){: width="700" height="400" }
```
{: .nolineno}
...
```markdown
![Desktop View](/common/img/cat.jpg){: w="700" h="400" }
```
{: .nolineno}
...
- **Normal position**
  ...
  ```markdown
  ![Desktop View](/common/img/cat.jpg){: .normal }
  ```
  {: .nolineno}
...
- **Float to the left**
  ...
  ```markdown
  ![Desktop View](/common/img/cat.jpg){: .left }
  ```
  {: .nolineno}
...
- **Float to the right**
  ...
  ```markdown
  ![Desktop View](/common/img/cat.jpg){: .right }
  ```
  {: .nolineno}
...
```markdown
![Desktop View](/common/img/cat.jpg){: .shadow }
```
{: .nolineno}
